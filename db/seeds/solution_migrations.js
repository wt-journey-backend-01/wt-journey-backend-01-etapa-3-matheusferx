exports.seed = async function(knex) {
  ...
  // Normaliza ids para serem inteiros
  const id1 = Array.isArray(agentesIds) ? (agentesIds[0].id || agentesIds[0]) : 1;
  const id2 = Array.isArray(agentesIds) ? (agentesIds[1].id || agentesIds[1]) : 2;
